/**
 * CLI command support for rapidcode
 * Allows users to open Rapid Code from terminal with: rapidcode . or rapidcode /path/to/project
 *
...
// Launch directory from CLI (e.g., `rapidcode /path/to/project`)
